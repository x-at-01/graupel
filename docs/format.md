...
Chimp128, which chooses the best reference from a 128-value window instead of always using
the immediately preceding value, is not implemented. See issue #1.
